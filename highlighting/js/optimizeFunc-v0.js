...
function getPaletteScore(p, sign = false) {
    ...
    let name_difference = 0, name_consistency = -100000
    for (let i = 0; i < class_number; i++) {
        ...
        if (bg_contrast_array[i] < 0) return -10000000
    ...
    let palette_score = score_importance_weight[0] * local_contrast + score_importance_weight[1] * background_contrast * 10 + score_importance_weight[2] * name_difference - score_importance_weight[3] * name_consistency
